...
IF(NOT SDL2_MIXER_BUILDING_LIBRARY)
	IF(NOT ${SDL2_MIXER_INCLUDE_DIR} MATCHES ".framework")
		...
		# necessarily need it.
		FIND_LIBRARY(SDL2_MIXERMAIN_LIBRARY
			NAMES SDL2_mixer
			HINTS
			$ENV{SDL2_MIXERDIR}
...
# It's total link flags should look like -lmingw32 -lSDL2_MIXERmain -lSDL2_MIXER -lmwindows
...
IF(SDL2_MIXER_LIBRARY_TEMP)
	...
	# For OS X, SDL2_MIXER uses Cocoa as a backend so it must link to Cocoa.
	...
	IF(APPLE)
		SET(SDL2_MIXER_LIBRARY_TEMP ${SDL2_MIXER_LIBRARY_TEMP} "-framework Cocoa")
	ENDIF(APPLE)
